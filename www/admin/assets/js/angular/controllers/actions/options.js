...
app.controller('actionOptions',['$scope','$element','$uibModal',
  ...
  $scope.dialogController = 'actionOptionsDialog';
...
app.controller('actionOptionsDialog',['$scope','$uibModalInstance','items','action','dic',
